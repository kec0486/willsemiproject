...
<script>
	...
	function update_go() {
		location.href = "tuitionupdate.jsp";
	}
</script>
</head>
<body>
		...
		<section>
			<div class="section">
				<div class="container">
					<!-- <h1>container</h1> -->
					<h1>등록금 정보 조회</h1>
					<form action="tuitionupdate.jsp">
					<input type="button" value="등록금 납부 여부 수정" onclick="update_go()">
					</form>
