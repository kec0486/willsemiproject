		...
		<aside>
			<div class="aside">
				...
				<div class="aside-menu">
					...
					<h3>등록금정보관리</h3>
					<ul>
						<li><a href="admin/tuitioninsert.jsp">등록금 정보입력</a></li>
						<li><a href="admin/tuitionupdate.jsp">등록금 정보수정</a></li>
						<li><a href="admin/tuitionselect.sjp">등록금 정보 조회</a></li>
					</ul>
					<h3>공지사항등록</h3>
					<ul>
