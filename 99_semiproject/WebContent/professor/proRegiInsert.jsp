			...
			<div class="section">
				...
				<table class="styled-table">
					...
					<form action="professor" method="post">
						과목 : <input type="text" name="sub_code"> 학생 이름 : <input
							type="text" name="st_name"> 점수 : <input type="text"
							name="re_score"> 성적 : <input type="text" name="re_grade">
						<input type="submit" value="성적입력"> <input type="hidden"
							name="type" value="proRegiInsert_ok">
					</form>
				</table>
			</div>
		</section>
