...
<script>
   ...
   function check_go(pro_id) {
      ...
      //컨트롤러로 이동
      location.href = "controller?type=professorSelectList&pro_id=" +  ${list.pro_id};
   }
   
   function update_go(pro_id) {
     // alert("update_go(st_id) 정상작동");
      location.href = "controller?type=professorUpdate&pro_id=" +  ${list.pro_id};
      
   }
   
   function check_prolec(pro_id){
      //alert("update_go(st_id) 정상작동");
      location.href = "controller?type=prolectureSelectList&pro_id=" +  ${list.pro_id};
