...
public class LecSubjectVO {
	...
	public LecSubjectVO(int pro_id, int sub_code, String sub_name, int sub_level, int sub_credit, String sub_day,
			String sub_time, String sub_class) {
		super();
		this.pro_id = pro_id;
	...
	public String toString() {
		return "LecSubjectVO [pro_id=" + pro_id + ", sub_code=" + sub_code + ", sub_name=" + sub_name + ", sub_level="
				+ sub_level + ", sub_credit=" + sub_credit + ", sub_day=" + sub_day + ", sub_time=" + sub_time
				+ ", sub_class=" + sub_class + "]";
	}
